    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('user.report') }}" method="POST" role="search" autocomplete="off">
                    @csrf
                    <div class="col-lg-3">
                        <label class="rdiobox">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2"
                                ...
                                <option value="فاتورة غير مدفوعة">الفواتير الغير مدفوعة</option>
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('user.section.show', $invoice->id) }}">{{ $invoice->section->section_name }}</a>
                                        </td>
