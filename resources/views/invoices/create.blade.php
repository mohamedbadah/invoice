...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.invoices.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col">
...
@section('js')
    ...
    <script>
        ...
        //     } else {
        //         let inResult1 = amount_Commission2 * rate_vat / 100;
        //         let inResult2 = parseFloat(inResult1 + amount_Commissiosn2);
        //         sumq = parseFloat(inResult1).toFixed(2);
        //         sumt = parseFloat(inResult2).toFixed(2);
