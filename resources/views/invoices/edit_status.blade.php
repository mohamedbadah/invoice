...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.update_status', $invoices->id) }}" method="post" autocomplete="off">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="يرجي ادخال رقم الفاتورة" value="{{ $invoices->invoice_nubmer }}" required
                                    readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="Status" name="Status" required>
                                    ...
                                    <option value="full">مدفوعة</option>
                                    <option value="part"> مدفوعة جزيئا</option>
                                </select>
                            </div>
