...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('user/' . ($pages = 'index')) }}"><svg
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('user/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('user.invoices.index') }}">قائمة الفواتير</a></li>
                        <li><a class="slide-item" href="{{ route('user.invoice_paid') }}">الفواتير
                                المدفوعة</a></li>
                        <li><a class="slide-item" href="{{ route('user.invoice_unpaid') }}">الفواتير
                                الغير
                                مدفوعة</a></li>
                        <li><a class="slide-item" href="{{ route('user.invoice_partical') }}">الفواتير
                                المدفوعة
                                جزئيا</a></li>
                        <li><a class="slide-item" href="{{ route('user.archive.index') }}">
                                الفواتير المؤرشفة</a></li>
                    </ul>
                </li>
            @endcan
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('user.indexCustomer') }}">تقارير العملاء</a></li>
                    <li><a class="slide-item" href="{{ route('user.report') }}">تقارير
                            الفواتير</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('user.indexs') }}">قائمة المستخدمين</a></li>
                    <li><a class="slide-item" href="{{ route('user.Roleindexs') }}">صلاحيات
                            المستخدمين</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('user.section.index') }}">اضافة قسم</a></li>
                    <li><a class="slide-item" href="{{ route('user.product.index') }}">اضافة منتج</a></li>
                </ul>
            </li>
        </ul>
    </div>
